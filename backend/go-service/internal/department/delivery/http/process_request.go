...
func (h handler) processCreateRequest(c *gin.Context) (createReq, models.Scope, error) {
	...
	if !ok {
		h.l.Warnf(ctx, "event.department.http.processCreateRequest.GetPayloadFromContext: unauthorized")
		return createReq{}, models.Scope{}, pkgErrors.NewUnauthorizedHTTPError()
	}

	var req createReq
	if err := c.ShouldBindJSON(&req); err != nil {
		h.l.Warnf(ctx, "event.department.http.processCreateRequest.ShouldBindJSON: %v", err)
		return createReq{}, models.Scope{}, errWrongBody
	}

	if err := req.validate(); err != nil {
		h.l.Warnf(ctx, "event.department.http.processCreateRequest.validate: %v", err)
...
func (h handler) processListRequest(c *gin.Context) (GetRequest, paginator.PaginatorQuery, models.Scope, error) {
	...
	payload, ok := jwt.GetPayloadFromContext(ctx)
	if !ok {
		h.l.Warnf(ctx, "event.department.http.processListRequest.GetPayloadFromContext: unauthorized")
	...
	if err := c.ShouldBindQuery(&pagin); err != nil {
		h.l.Warnf(ctx, "event.department.http.processListRequest.ShouldBindQuery: %v", err)
		return GetRequest{}, pagin, models.Scope{}, err
	}
...
func (h handler) processGetByIDRequest(c *gin.Context) (models.Scope, GetByIDRequest, error) {
	...
	payload, ok := jwt.GetPayloadFromContext(ctx)
	if !ok {
		h.l.Warnf(ctx, "event.department.http.processGetByIDRequest.GetPayloadFromContext: unauthorized")
...
func (h handler) processUpdateRequest(c *gin.Context) (updateReq, models.Scope, string, error) {
	...
	payload, ok := jwt.GetPayloadFromContext(ctx)
	if !ok {
		h.l.Warnf(ctx, "event.department.http.processUpdateRequest.GetPayloadFromContext: unauthorized")
		return updateReq{}, models.Scope{}, "", pkgErrors.NewUnauthorizedHTTPError()
	}

	var req updateReq
	if err := c.ShouldBindJSON(&req); err != nil {
		h.l.Warnf(ctx, "event.department.http.processUpdateRequest.ShouldBindJSON: %v", err)
		return updateReq{}, models.Scope{}, "", errWrongBody
	}

	if err := req.validate(); err != nil {
		h.l.Warnf(ctx, "event.department.http.processUpdateRequest.validate: %v", err)
...
func (h handler) processDeleteRequest(c *gin.Context) (models.Scope, string, error) {
	...
	payload, ok := jwt.GetPayloadFromContext(ctx)
	if !ok {
		h.l.Warnf(ctx, "event.department.http.processDeleteRequest.GetPayloadFromContext: unauthorized")
