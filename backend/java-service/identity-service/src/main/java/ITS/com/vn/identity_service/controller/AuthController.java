...
// @PostMapping("/refresh")
// public ApiResponse<TokenResponse> refresh(@RequestBody RefreshTokenRequest
// req) {
...
// public ApiResponse<List<TokenSession> >listSessions(@PathVariable String
// username) {
// return
// ApiResponse.<List<TokenSession>>builder().statusCode(200).message("success").body(authService.listSessions(username)).build();
// }
