...
import ITS.com.vn.user_profile_service.dto.document.FavoriteToggleRequest;
...
public class DocumentController {
    ...
    public ResponseEntity<List<DocumentResponse>> listDocuments(
        ...
        return ResponseEntity.ok(documentService.getDocuments(resolveCategory(category), isFavorite, query));
    }
    ...
    @PreAuthorize("isAuthenticated()")
    public ResponseEntity<DocumentResponse> toggleFavorite(@PathVariable UUID id,
