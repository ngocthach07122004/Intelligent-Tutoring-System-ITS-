...
export default function ServerChannelSidebar({
  ...
  return (
    <div className="w-full md:w-72 bg-gray-100 border-r border-gray-300 px-4 py-6 flex flex-col h-full">
      {/* Tiêu đề server */}
      <div className="flex items-center justify-between mb-6 border-b border-gray-300 pb-4 -mx-4 px-4">
        <h2 className="text-lg font-semibold text-black truncate px-1">{serverName}</h2>
        <button
